...
# # # first_addmin = users.get("admins", [])[0].get("name")
# # # print(first_addmin)
...
#     total_width=6
# ):
#     # TODO: replace direct dictionary access with book.get(key, default)
#     print(
#         f"{book.get('id', 'Unknown'):<{id_width}}"
