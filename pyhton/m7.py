...
def update_book(book_list):
    ...
    for book in book_list:
        # TODO: if Book ID matches
        if book.get("id") == book_id:
            # TODO: ask for new total copies
            new_total = int(input("Enter new total copies"))
            # TODO: ask for new available copies
            new_available = int(input("Enter new available copies"))
            # TODO: use update() to update the book dictionary
            # book_list.update({"available": new_available}, {"total":new_total})
            book_list.update({
                "available": new_available,
                "total":new_total
                })

            # TODO: print "Book updated successfully"
            print("Book updated successfully")
            # TODO: stop searching
            return
    print("Book not found")
    # TODO: if book was not found, print "Book not found"
